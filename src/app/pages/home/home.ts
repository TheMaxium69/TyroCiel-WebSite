  ...
  readonly games = [
    {
      ...
      descriptionEn: 'Rhodotales is an HD-2D platformer set in a fantastical medieval world. Its signature mechanic: shifting between 3 distinct planes — foreground, midground and background — for dynamic sequences and a depth of gameplay rarely seen in the genre.',
    ...
    },
    {
      ...
      description: 'Adapté de l\'univers de notre serveur Minecraft TyroServ, ce jeu d\'aventure solo en monde ouvert plonge dans un vaste univers fantasy. Il reprend et réinvente la mécanique de fusion de minerai du serveur : combinez des minerais pour forger de nouvelles capacités et de nouveau pouvoir.',
      descriptionEn: 'Adapted from the universe of our Minecraft server TyroServ, this solo open world adventure game dives into a vast fantasy universe. It reimagines the server\'s ore fusion mechanic: combine minerals to forge new abilities and shape a truly unique adventure every playthrough.',
      status: 'Concept',
      statusEn: 'Concept',
